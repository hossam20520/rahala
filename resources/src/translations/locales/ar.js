...
export default {
    ...
    DateImage:'صورة البوستر',
    en_name:'الاسم بالانجليزي',
    ar_name:'الاسم بالعربي',
    Name_ar_name:'الاسم بالعربي',
    Name_en_name:'الاسم بالانجلش',
    Date:'مواعيد الحلقات',
    publish_status:'حالة النشر',
    MovieDetails:'تفاصيل الفيلم',
    EpisodeDetails:'تفاصيل الحلقة',
    UpdateMovie:'تعديل الفيلم',




    User:'احصائيات المستخدمين',
    Subscriper:'عدد المشتركين',
    Clients:'عدد المستخدمين',
    SeriesD:'احصائيات المسلسلات والافلام',
    Category:'الفئات',

    AddMovie:'اضافة فيلم بالعربي',
    Name_en_nameMov:'اسم الفيلم بالانجليزي',
    Name_ar_name_mov:'اسم الفيلم بالعربي',
    moviesList:'قائمة الافلام',
    Movies:'الافلام',
    NamecategorieD:'اسم الفئة بالعربي',
    en_nameCa:'اسم الفئة بالانجليزي',
    ...
    price:'سعر الباقة (ريال)',
    days:'عدد الايام',
    Package_en_name:'اسم الباقة بالانجليزي',
    Package_ar_name:'اسم الباقة بالعربي',
    Package:'الباقات',
    AddEpisodea:'اضافة حلقة جديدة',
    updateEpisodes:'تعديل الحلقة',
    en_Name_episodes:'اسم الحلقة بالانجليزي',
    ar_Name_episodes:'اسم الحلقة بالعربي',
    episodesListt:'جميع الحلقات',
    story_en:'القصة بالانجليزي',
    story_ar:'القصة بالعربي',
    premium:'هل مدفوع ؟',
    aired_end_date:'تاريخ انتهاء النشر',
    aired_start_date:'تاريخ بدء النشر',
    aired:'تاريخ النشر',
    Choose_status:'اختر حالة النشر',
    Video_quality_1:'جودة (480p)',
    Video_quality_2:'جودة (720p)',
    Video_quality_3:'جودة (1080p)',
    AddEpisode:'اضافة مسلسل جديد',
    rate:'التقييم العالمي',
    Choose_age:'اختر الفئة العمرية',
    age:'الفئة العمرية',
    SeriesImage:'صورة بوستر المسلسل',
    Series:'المسلسلات',
    status:'الحالة',
    en_Name_episode:'اسم المسلسل بالانجليزي',
    ar_Name_episode:'اسم المسلسل بالعربي',
    episodesList:'جميع المسلسلات',
    Episodes:'المسلسلات',
    deferred:'الاجلة',
