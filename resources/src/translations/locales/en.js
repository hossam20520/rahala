...
export default {
    ...
    DateImage:'Image',
    Name_ar_name:'Ar Name',
    Name_en_name:'En Name',
    ...
    User:'Users Analytics',
 
    Clients:'ِClient Numbers',
    SeriesD:'Series And Movies ',
    Category:'Category',


    AddMovie:'Add Movie',
    Name_en_nameMov:'English Movie Name',
    Name_ar_name_mov:'Arabic Movie Name',
    moviesList:'Movie List',
    Movies:'Movies',
    NamecategorieD:'Arabic Gener Name',
    en_nameCa:'English Gener Name',
    amount:'Amount',
    end_date:'End Date Subscription',
    start_date:'First Date Subscription',
    phone:'Phone',
    email:'Email',
    lastname:'Last Name',
    ...
    price:'Price (ORM)',
    days:'Days Number',
    Package_en_name:'English Package Name',
    Package_ar_name:'Arabic Package Name',
    Package:'Packages',
    AddEpisodea:'Add Episode ',
    updateEpisodes:'Update Episode',
    en_Name_episodes:'English Episode Name',
    ar_Name_episodes:'Arabic Episode Name',
    episodesListt:'Episodes List',
    story_en:'English Story',
    story_ar:'Arabic Story',
    premium:'premium'   ,
    aired_end_date:'Aired End Date',
    aired_start_date:'Aired Start Date',
    aired:'Aired',
    Choose_status:'Choose Status ',
    Video_quality_1:'Quality (480p)',
    Video_quality_2:'Quality (720p)',
    Video_quality_3:'Quality (1080p)',
    AddEpisode:'Add new Episode',
    rate:'International Rate',
    Choose_age:'Choose Age',
    age:'age',
    SeriesImage:'Image',
    Series:'Series',
    status:'status',
    en_Name_episode:'English Episode Name',
    ar_Name_episode:'Arabic Episode Name',
    episodesList:'Episode List',
    Episodes:'Episodes',
