...
<template>
  <div class="main-content">
    <breadcumb :page="$t('Deal')" :folder="$t('Settings')"/>
    ...
    <b-card class="wrapper" v-if="!isLoading">
      ...
      >
        ...
        <div slot="table-actions" class="mt-2 mb-3">
          <b-button @click="New_Deal()" class="btn-rounded" variant="btn btn-primary btn-icon m-1">
            <i class="i-Add"></i>
             {{ $t('Add') }}
          </b-button>
        </div>
        ...
        <template slot="table-row" slot-scope="props">
          <span v-if="props.column.field == 'actions'">
            <a @click="Edit_Deal(props.row)" title="Edit" v-b-tooltip.hover>
              <i class="i-Edit text-25 text-success"></i>
            </a>
            <a title="Delete" v-b-tooltip.hover @click="Delete_Deal(props.row.id)">
          ...
          <span v-else-if="props.column.field == 'image'">
            <b-img
              ...
              width="50"
              fluid
              :src="'/images/deals/' + props.row.image"
              alt="image"
            ></b-img>
          </span>
        </template>
    ...
    <validation-observer ref="Create_deal">
      <b-modal hide-footer size="md" id="New_deal" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Deal" enctype="multipart/form-data">
          <b-row>
            <!-- Deal Name -->
...
export default {
  ...
  methods: {
    ...
    async onFileSelected(e) {
      ...
      if (valid) {
        this.deal.image = e.target.files[0];
      } else {
        this.deal.image = "";
      }
    },
    ...
    delete_by_selected() {
      this.$swal({
        ...
        if (result.value) {
          ...
          NProgress.set(0.1);
          axios
            .post("deals/delete/by_selection", {
