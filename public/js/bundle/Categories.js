          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (valid) {
                  _this6.category.image = e.target.files[0];
                } else {
                  _this6.category.image = "";
                }
                                ...
                                fn: function (validationContext) {
                                  return [
                                    _c(
                                      "b-form-group",
                                      {
                                        attrs: { label: _vm.$t("ar_category") },
                                      },
                                      [
                                        _c("b-form-input", {
                                          attrs: {
                                            placeholder: _vm.$t("ar_category"),
                                            state:
                                ...
                                fn: function (validationContext) {
                                  return [
                                    _c(
                                      "b-form-group",
                                      {
                                        attrs: { label: _vm.$t("en_category") },
                                      },
                                      [
                                        _c("b-form-input", {
                                          attrs: {
                                            placeholder: _vm.$t("en_category"),
                                            state:
                                              _vm.getValidationState(
                                                validationContext
                                              ),
