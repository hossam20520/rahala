        ...
        this.timer = setTimeout(function () {
          ...
          if (product_filter.length === 1) {
            ...
            _this.product_filter = _this.products.filter(function (product) {
              return product.name.toLowerCase().startsWith(_this.search_input.toLowerCase()) || product.code.toLowerCase().startsWith(_this.search_input.toLowerCase()) || product.barcode.toLowerCase().startsWith(_this.search_input.toLowerCase());
            });
          }
        }, 800);
      } else {
                ...
                "b-form",
                {
                  on: {
                    submit: function ($event) {
                      ...
                      return _vm.Submit_Adjustment($event)
                    },
                  },
                },
                [
